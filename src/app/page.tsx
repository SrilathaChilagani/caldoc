        ...
        <div className="relative container mx-auto px-6 lg:px-12">
          <div className="max-w-2xl pt-16">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link
                href="/emergency"
                className="inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-rose-200 bg-rose-50 px-8 text-sm font-semibold text-rose-700 shadow-sm transition hover:bg-rose-100"
              >
