...
export default async function CheckoutPage({ searchParams }: PageProps) {
  ...
  if (!appointmentId) {
    return (
    <main className="mx-auto max-w-3xl min-h-[calc(100vh-120px)] bg-[#f7f9fc] px-4 py-16 text-center">
  ...
  return (
    <main className="mx-auto max-w-3xl min-h-[calc(100vh-120px)] bg-[#f7f9fc] px-4 py-16">
