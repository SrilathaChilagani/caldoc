export const metadata = { title: "Terms of Service | Telemed India" };
  ...
  return (
    <main className="mx-auto max-w-4xl space-y-4 px-4 py-12 text-slate-800">
      ...
      <p className="text-sm text-slate-600">
        These highlights describe the legal expectations between Telemed India, registered providers, and
      ...
      <ol className="list-decimal space-y-2 pl-6 text-sm text-slate-700">
        <li>Telemed India is a technology platform. Consultations are performed solely by licensed registered medical practitioners.</li>
